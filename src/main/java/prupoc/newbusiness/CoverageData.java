...
public class CoverageData implements java.io.Serializable
{
   ...
   @org.kie.api.definition.type.Label("Age (Year)")
   private java.lang.Integer ageInYear;

   @org.kie.api.definition.type.Label("Age (month)")
   private java.lang.Integer ageInMonth;

   @org.kie.api.definition.type.Label("Product Category")
   private java.lang.String ruleResultProductCategory;

   private BigDecimal ruleResultSumAssuredHigherIDRNML;

   private BigDecimal currentADDSumAssured;

   private BigDecimal currentLifeSumAssured;
   ...
   public java.lang.String getRuleResultProductCategory()
   {
      return this.ruleResultProductCategory;
   }

   public void setRuleResultProductCategory(
         java.lang.String ruleResultProductCategory)
   {
      this.ruleResultProductCategory = ruleResultProductCategory;
   }

   public java.math.BigDecimal getCurrentADDSumAssured()
   {
      return this.currentADDSumAssured;
   }

   public void setCurrentADDSumAssured(java.math.BigDecimal currentADDSumAssured)
   {
      this.currentADDSumAssured = currentADDSumAssured;
   }

   public java.math.BigDecimal getCurrentLifeSumAssured()
   {
      return this.currentLifeSumAssured;
   }

   public void setCurrentLifeSumAssured(java.math.BigDecimal currentLifeSumAssured)
   {
      this.currentLifeSumAssured = currentLifeSumAssured;
   }

   public java.math.BigDecimal getRuleResultSumAssuredHigherIDRNML()
   {
      return this.ruleResultSumAssuredHigherIDRNML;
   }

   public void setRuleResultSumAssuredHigherIDRNML(
         java.math.BigDecimal ruleResultSumAssuredHigherIDRNML)
   {
      this.ruleResultSumAssuredHigherIDRNML = ruleResultSumAssuredHigherIDRNML;
   }
   ...
   public CoverageData(
         ...
         java.lang.String ruleResultProductCategory,
         java.math.BigDecimal ruleResultSumAssuredHigherIDRNML,
         java.math.BigDecimal currentADDSumAssured,
         java.math.BigDecimal currentLifeSumAssured)
   {
      this.documentType = documentType;
      this.gender = gender;
      this.maritalStatus = maritalStatus;
...
public String toString() {
	return "CoverageData [documentType=" + documentType + ", gender=" + gender
			+ ", maritalStatus=" + maritalStatus + ", height=" + height
			+ ", weight=" + weight + ", policyNumber=" + policyNumber
			+ ", policyCode=" + policyCode + ", productCode=" + productCode
			+ ", policyOwner=" + policyOwner + ", insurableInterest="
			+ insurableInterest + ", occupation=" + occupation + ", forenames="
			+ forenames + ", surname=" + surname + ", dateOfBirth=" + dateOfBirth 
			+ ", ageInYear=" + ageInYear + ", ageInMonth=" + ageInMonth
			+ ", ruleResultBMI=" + ruleResultBMI
			+ ", ruleResultInsurableInterest=" + ruleResultInsurableInterest
			+ ", ruleResultOccupationBenefit=" + ruleResultOccupationBenefit
			+ ", ruleResultNonMedicalLimit=" + ruleResultNonMedicalLimit
			+ ", ruleResultBenefitLife=" + ruleResultBenefitLife
			+ ", ruleResultBenefitADD=" + ruleResultBenefitADD
			+ ", ruleResultBenefitTPD=" + ruleResultBenefitTPD
			+ ", ruleResultBenefitCC=" + ruleResultBenefitCC
			+ ", ruleResultBenefitHealth=" + ruleResultBenefitHealth
			 + "]";
}
